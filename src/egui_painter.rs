...
impl engine::ScreenPainter for EguiPainter {
    ...
    fn draw_line(&mut self, start: primitives::Vector2, end: primitives::Vector2, stroke: primitives::Stroke) {
        self.painter.line_segment([egui::Pos2::from(start), egui::Pos2::from(end)], egui::Stroke::from(stroke));
    }
    
    fn draw_circle(&mut self, center: primitives::Vector2, radius: f32, stroke: primitives::Stroke) {
        self.painter.circle_filled(egui::Pos2::from(center), radius, stroke.color);
    }
    
    fn draw_rectangle(&mut self, rectangle: primitives::Rectangle, stroke: primitives::Stroke) {
        let corner_rounding = 0.0;
        self.painter.rect_stroke(egui::Rect::from(rectangle), corner_rounding, stroke);
    }
    
    fn draw_rectangle_filled(&mut self, rectangle: primitives::Rectangle, color: primitives::Color, stroke: Option<primitives::Stroke>) {
    ...
    fn draw_image(&mut self, frame: primitives::Rectangle, texture: &Self::Texture) {
...
impl From<primitives::Vector2> for egui::Pos2 {
    fn from(other: primitives::Vector2) -> egui::Pos2 {
        egui::Pos2 {
            x: other.x,
            y: other.y,
        }
...
impl From<egui::Pos2> for primitives::Vector2 {
    fn from(other: egui::Pos2) -> primitives::Vector2 {
        primitives::Vector2 {
            x: other.x,
            y: other.y,
        }
...
impl From<egui::Vec2> for primitives::Vector2 {
    fn from(other: egui::Vec2) -> primitives::Vector2 {
        primitives::Vector2 {
            x: other.x,
            y: other.y,
        }
...
impl From<primitives::Rectangle> for egui::Rect {
    fn from(other: primitives::Rectangle) -> egui::Rect {
